...
const OrderSummary = props => (
   <ul  className='OrderSummary__List'>
      <li  className="OrderSummary__Header-Row">
         ...
         {props.searchResult.recipient ? <div  className="OrderSummary__Header-Col">Получатель</div> : null}
      </li> 
      <li className="OrderSummary__Body-Row">
         ...
         <div className="OrderSummary__Body-Col">{props.searchResult.delivered ? 'В пути' : 'Доставлено' }</div>
